...
export const StoreContainer = () => {
  ...
  return (
    <div className=" h-fit   flex flex-col  min-[768px]:flex-row min-[768px]:w-[100vw] ">
      <Filters />
      <div
        className="flex w-[100vw] flex-wrap  gap-5  max-[320px]:w-[380px] -mt-96 sm:-mt-30 md:mt-5 p-10
      ...
      >
        {categorySelected === null &&
          products.map((prod, index) => <Products {...prod} key={index} />)}
        {categorySelected !== null &&
          prodsPorCategory.map((prod, index) => (
