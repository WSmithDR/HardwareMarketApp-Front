...
export const Filters = () => {
  ...
  return (
    <div className=" w-[400px] h-[500px] flex flex-col items-start  p-10 gap-10 ml-16">
      ...
      <div className="bg-[#C8C7C7] h-[40px] w-[100%] rounded-[10px] items-center p-4 justify-between hidden sm:flex">
        <p>Envio Gratis</p>
        <SwitchButton />
      </div>
      <p
