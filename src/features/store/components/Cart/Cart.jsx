...
export const Cart = ({cartOpen, handleCart}) => {
    ...
    const openStyle = "fixed top-[115px] right-0 bg-white w-[300px] h-[600px]   p-8 ml-2 mr-4 mt-[-10px] shadow-[0_3px_2px_0_rgba(0,0,0,0.3)] ease-out duration-200 translate-x-[0rem]"
    ...
    return (
        <div className={cartOpen ? closedStyle : openStyle}>
